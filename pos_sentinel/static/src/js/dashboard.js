...
// Lazy map — _t() is called at access time, not at module load time,
// so that the user's locale is guaranteed to be loaded.
...
function getEventTypeLabel(type) {
    const raw = EVENT_TYPE_KEYS[type];
    return raw ? _t(raw) : type;
}
